...
namespace PhotoLiker
{
    public class Program
    {
        public class Config
        {
            ...
            public class OnlinerEntity
            {
                public IEnumerable<long> tbf;
            }
        ...
        public static void Main(string[] args)
        {
            ...
            catch (FileNotFoundException e)
            {
                config = new Config
                {
                    ...
                    NewYears = new List<Config.HappyNewYearEntity>(new[]
                        {new Config.HappyNewYearEntity(), new Config.HappyNewYearEntity(),})
                };
